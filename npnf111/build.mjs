...
// Fathers, Series I, Volume 11 from CCEL, parses, strips footnotes, writes
// npnf111.json for Foundation's compound-work import.
//
// PROVENANCE — NPNF Series I, Vol. 11: Chrysostom: Homilies on the Acts of the Apostles and the Epistle to the Romans.
...
// 1,710 are balanced, none nested and none self-closing, so the non-greedy
...
//
// STRUCTURE — two separate div1 works, not one merged homily list: 55
// homilies on Acts and 32 on Romans (the latter behind a Preface and an
// Argument). Both label their homilies fully in `title` ("Homily I on Acts
// i. 1, 2."), so div2Title()'s folding is a no-op here. No div3 anywhere.
