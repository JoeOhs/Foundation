...
// Fathers, Series I, Volume 12 from CCEL, parses, strips footnotes, writes
// npnf112.json for Foundation's compound-work import.
//
// PROVENANCE — NPNF Series I, Vol. 12: Chrysostom: Homilies on First and
// Second Corinthians.
...
// 1,059 are balanced, none nested and none self-closing, so the non-greedy
...
//
// STRUCTURE — two div1 works, First and Second Corinthians, each a flat run
// of homilies with no div3. Titles already read "Homily I", so no label
// folding is needed here (Vol. 14, whose titles repeat, is why it exists).
