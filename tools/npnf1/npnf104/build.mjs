...
// Fathers, Series I, Volume 4 from CCEL, parses, strips footnotes, writes
// npnf104.json for Foundation's compound-work import.
//
// PROVENANCE — NPNF Series I, Vol. 4:
// Augustine: Anti-Manichaean Writings, Anti-Donatist Writings.
...
// 2,570 are balanced, none nested and none self-closing, so the non-greedy
...
//
// STRUCTURE — Book containers, with several treatises whose div2s hold
// text directly and so become chapters of one work rather than a work
// apiece.
...
const VOLUME_TITLE =
  'Nicene and Post-Nicene Fathers, Series I, Vol. 4: Augustine: Anti-Manichaean Writings, Anti-Donatist Writings';
