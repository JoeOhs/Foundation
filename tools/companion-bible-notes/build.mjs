...
// ../../public/library/commentaries/companion-bible-notes.json, the single bundle that
...
const OUT_DIR = path.join(__dirname, '..', '..', 'public', 'library', 'commentaries');
...
const ASSET_URL_BASE = '/library/commentaries/companion-bible-notes/';
