...
// Fathers, Series I, Volume 8 from CCEL, parses, strips footnotes, writes
// npnf108.json for Foundation's compound-work import.
//
// PROVENANCE — NPNF Series I, Vol. 8:
...
// 6,022 are balanced, none nested and none self-closing, so the non-greedy
...
//
// STRUCTURE — one flat run of 150 Psalm expositions. Four of them are
// internally subdivided (Psalm CXIX into its 22 acrostic stanzas), which is
// why groupDiv2s() weighs where the text sits rather than counting
// div3-bearing div2s: each stays one chapter, stanza headings kept inline.
