...
//
// PROVENANCE — NPNF Series I, Vol. 4: Augustine: The Anti-Manichaean Writings,
// The Anti-Donatist Writings. Edited by Philip Schaff. First published
// 1886–1889. Public domain.
//
...
function buildBundle(xml) {
  ...
  return {
    metadata: {
      title: 'Nicene and Post-Nicene Fathers, Series I, Vol. 4: Augustine: Anti-Manichaean Writings, Anti-Donatist Writings',
      series: 'Nicene and Post-Nicene Fathers, Series I',
      volume: 4, editor: 'Philip Schaff',
      source_url: 'https://ccel.org/ccel/schaff/npnf104', source_format: 'ThML XML',
