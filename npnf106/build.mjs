...
//
// PROVENANCE — NPNF Series I, Vol. 6:
...
// 4,328 are balanced, none nested and none self-closing, so the non-greedy
...
//
// STRUCTURE — the Harmony is a Book container (Books I-IV with div3
// chapters); the Sermon on the Mount splits into two div3-bearing works;
// the 97 Sermons are a flat run of div2 chapters.
